...
import com.fesskiev.programmingsamples.threads.synchronizers.Data;

import java.util.UUID;

public class ConsumerProducer {

    private static final com.fesskiev.programmingsamples.threads.synchronizers.Data<String> data = new Data<>();
