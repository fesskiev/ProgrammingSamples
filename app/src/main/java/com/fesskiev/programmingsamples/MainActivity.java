...
import com.fesskiev.programmingsamples.android.threads.AndroidThreadsActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupButtons() {
        ...
        findViewById(R.id.threadsAndroidButton).setOnClickListener(v -> startActivity(new Intent(MainActivity.this, AndroidThreadsActivity.class)));
